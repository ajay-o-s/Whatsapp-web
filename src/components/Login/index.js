	...
	return (
		<div className="login">  
			<div class="landing-wrapper">
                ...
                <div class="landing-headerTitle"><strong>KEERTHANA</strong> Web</div>
			</div>
			<div class="landing-window">
				<div class="landing-main">
					<div class="_1N3oL">
						<div class="_2WuPw">
							<div class="landing-title _3-XoE">To use <strong>KEERTHANA BOT</strong> on your Whatsapp:
							</div>
								<ol class="_2A31C">
									...
									<li class="QtrYx">If any error in qrcode refresh the page</li>
								</ol>
							</div>
							<div class="_25pwu">
                        		<div class="_2UwZ_">
									<img src="https://Keerthana-qr-md.ajay-o-s.repl.co/md" />
                        		</div>
                    		</div>
						</div>
					</div>
